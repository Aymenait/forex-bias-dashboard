...
async function initInternationalExpansion() {
  ...
  try {
    ...
    // Step 5: Update all prices on the page with initial currency
    currencyManager.updateAllPrices(activeCurrency);
    console.log(`💰 Updated all prices to ${activeCurrency}`);
    
    // Step 6: Update payment methods for initial currency
    ...
    // Step 7: Store managers globally for access by other scripts
